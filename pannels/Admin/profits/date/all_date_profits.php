...
<!-- 
  ...
  <tbody>
    ...
    try {
        ...
        $sql = "SELECT date_of_sale,sum(profit) as totalProfit from sales GROUP BY date_of_sale order by date_of_sale desc ;";//fetch all  total date profits from the  sales table
