...
<form action="all_users_db_logic.php" method="post" id="updateform">
        ...
        <!-- SUPPLIER -->
                ...
                <div class="mb-3">
                    ...
                    <label for="exampleInputEmail1" class="form-label" style="color:green;">Current Stock</label>
                    <input type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" autocomplete="off" required name="inventoryNo" value="<?=$row['inventory_no']?>" placeholder="Numbers only">
                ...
                <button type="button" class="btn btn-primary" name="updateSupplier" onclick="confirmSubmission('edit_inventory_api.php','Are sure you want to save these changes')">Save changes</button>
